...
func 初始化属性() -> void:
	获取属性("生命值").一次性修改属性(单位属性修改器.修改类型枚举.强行设置_软, 获取属性("最大生命值").获取最终值())
...
func 受到伤害(伤害值:float) -> void:
	...
	var 剩余生命值 = 获取属性值("生命值")
	var 最大生命值 = 获取属性值("最大生命值")
	print("%s 受到 %d 点伤害，剩余生命： %s/%s" % [owner.name, 伤害值, 剩余生命值, 最大生命值])
...
func 受到治疗(治疗值:float) -> void:
	...
	var 剩余生命值 = 获取属性值("生命值")
	var 最大生命值 = 获取属性值("最大生命值")
	print("%s 受到 %d 点治疗，当前生命： %s/%s" % [owner.name, 治疗值, 剩余生命值, 最大生命值])
